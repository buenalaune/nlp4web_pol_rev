...
print('''Evaluation of exchange of adjectives to good/bad and
adverbs to well/badly with knowledge of predicted label''')
classifier.calculate_domain(test)
classifier.calculate_polarity(test)

# Exchange adjectives to good/bad and adverbs to well/badly with knowledge
# of true class label
test = '../out/evaluation_examples_word_ex_simple.csv'
with open(test, 'w') as file:
    for row in data.itertuples():
...
print('''Evaluation of exchange of adjectives to good/bad and
adverbs to well/badly with knowledge of true label''')
classifier.calculate_domain(test)
classifier.calculate_polarity(test)